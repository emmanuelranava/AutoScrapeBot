    ...
    while True:
        ...
        if count > 0:
            ...
            if recipients:
                ...
                body = f"{count} nouvelles données ont été ajoutées à la base de données."
            ...
            if recipients:
                ...
                body = "Le scraping est terminé ! Aucune nouvelle donnée n'a été ajoutée à la base de données."
                send_email(recipients, subject, body)
